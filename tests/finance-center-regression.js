...
assert.equal(fs.readFileSync("service-worker.js", "utf8").includes("tsubin-finance-center-v115"), true, "service worker cache must be bumped for credit statement checklist styling");
