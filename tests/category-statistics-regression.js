...
ledger.entries.push(entry('legacy-cash-adjustment',2000,{category:'現金盤點調整'}));
ledger.entries.push(entry('legacy-cash-income-adjustment',3000,{category:' 現金盤點調整 ',type:'income'}));
