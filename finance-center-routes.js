(function () {
  ...
  const routes = {
    ...
    daily: { label: "日常記帳", tabs: [["quick", "快速記帳"], ["lookup", "查帳"], ["calendar", "月份行事曆"], ["records", "收支明細"], ["statistics", "收支統計"], ["taxonomy", "分類與項目"], ["budgets", "分類預算"], ["recurring", "固定收支"], ["closeout", "月結"]] },
    accounts: { label: "帳戶與負債", tabs: [["accounts", "帳戶總覽"], ["transfer", "帳戶轉帳"], ["credit", "信用卡帳單與核對"], ["installments", "信用卡分期"], ["loans", "貸款管理"], ["reconcile", "帳戶盤點"]] },
